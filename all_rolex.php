...
<head>
    <meta charset="UTF-8">
    <title>Đồng hồ Rolex Chính Hãng - Timeless</title>
    ...
    <nav class="main-nav">
        <ul>
            ...
            <li class="dropdown"><a href="#" style="color: #b58b5a; font-weight: bold;">THƯƠNG HIỆU <i class="fa fa-caret-down"></i></a>
                <ul class="dropdown-content"><li><a href="all_rolex.php" style="color:#b58b5a;font-weight:bold;">ROLEX</a></li><li><a href="all_omega.php">OMEGA</a></li><li><a href="all_casio.php">CASIO</a></li><li><a href="all_seiko.php">SEIKO</a></li><li><a href="all_hublot.php">HUBLOT</a></li></ul>
            </li>
...
<section class="banner">
    <div class="banner-slider">
        <div class="banner-item active">
            <img src="image/nenrolex.jpg" alt="Rolex Premium">
        </div>
    </div>
</section>
...
<div class="product-page-header">
    ...
    <h1 class="main-title">Đồng Hồ Rolex Chính Hãng</h1>
