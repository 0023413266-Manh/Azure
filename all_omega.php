...
// OMEGA = ID 3
$sql = "SELECT * FROM san_pham WHERE id_thuong_hieu = 3 $price_sql $order_sql";
...
<head>
    <meta charset="UTF-8">
    <title>Đồng hồ Omega Chính Hãng - Timeless</title>
    ...
    <nav class="main-nav">
        <ul>
            ...
            <li class="dropdown"><a href="#" style="color: #b58b5a; font-weight: bold;">THƯƠNG HIỆU <i class="fa fa-caret-down"></i></a>
                <ul class="dropdown-content"><li><a href="all_rolex.php">ROLEX</a></li><li><a href="all_omega.php" style="color:#b58b5a;font-weight:bold; background-color: #f9f9f9 !important; padding-left: 25px !important;">OMEGA</a></li><li><a href="all_casio.php">CASIO</a></li><li><a href="all_seiko.php">SEIKO</a></li><li><a href="all_hublot.php">HUBLOT</a></li></ul>
            </li>
...
<section class="banner">
    <div class="banner-slider">
        <div class="banner-item active">
            <img src="image/nenomega.jpg" alt="Omega Premium" onerror="this.src='image/nenomega.jpg'">
        </div>
    </div>
</section>

<div class="product-page-header">
    <nav class="breadcrumb"><a href="index.php">Home</a> >> <span class="current-page">Đồng Hồ Omega Chính Hãng Giá Tốt Nhất</span></nav>
    <h1 class="main-title">Đồng Hồ Omega Chính Hãng</h1>
    <div class="brand-description">
        <p>Đồng hồ Omega nổi tiếng với các BST Omega Seamaster, Omega Speedmaster, Omega Constellation hay Omega De Ville. Thương hiệu Omega được giới thượng lưu Việt yêu thích và ưa chuộng bởi vẻ ngoài lịch lãm, kỹ thuật chế tác đỉnh cao, là biểu tượng của sự thành đạt và gu thẩm mỹ tinh tế.</p>
    </div>
            ...
            <div class="hublot-track" style="display: flex !important; width: 100%; margin: 0; padding: 0;">
                <?php if ($result && $result->num_rows > 0): ?>
                    ...
                    <div class="product-item">
                        <a href="chi_tiet_sp/chi_tiet_omega.php?id=<?php echo $row['id']; ?>" style="display:block; text-decoration:none; color:inherit;">
