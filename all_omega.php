...
<section class="banner">
    <div class="banner-slider">
        <div class="banner-item active">
            <img src="image/nenomega.jpg" alt="Omega Premium" onerror="this.src='image/nenomega.jpg'" style="width:100%; height:auto;">
        </div>
    </div>
</section>
...
<div class="omega-container">
    ...
    <h1 class="main-title" style="margin-top: 10px;">Đồng Hồ Omega Chính Hãng</h1>
