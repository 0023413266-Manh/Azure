...
// HUBLOT = ID 2
$sql = "SELECT * FROM san_pham WHERE id_thuong_hieu = 2 $price_sql $order_sql";
...
<head>
    <meta charset="UTF-8">
    <title>Đồng hồ Hublot Chính Hãng - Timeless</title>
    ...
    <nav class="main-nav">
        <ul>
            ...
            <li class="dropdown"><a href="#" style="color: #b58b5a; font-weight: bold;">THƯƠNG HIỆU <i class="fa fa-caret-down"></i></a>
                <ul class="dropdown-content"><li><a href="all_rolex.php">ROLEX</a></li><li><a href="all_omega.php">OMEGA</a></li><li><a href="all_casio.php">CASIO</a></li><li><a href="all_seiko.php">SEIKO</a></li><li><a href="all_hublot.php" style="color:#b58b5a;font-weight:bold; background-color: #f9f9f9 !important; padding-left: 25px !important;">HUBLOT</a></li></ul>
            </li>
...
<section class="banner">
    <div class="banner-slider">
        <div class="banner-item active">
            <img src="image/nenhublot.jpg" alt="Hublot Premium" onerror="this.src='image/nenrolex.jpg'">
        </div>
    </div>
</section>

<div class="product-page-header">
    <nav class="breadcrumb"><a href="index.php">Home</a> >> <span class="current-page">Đồng Hồ Hublot Chính Hãng Giá Tốt Nhất</span></nav>
    <h1 class="main-title">Đồng Hồ Hublot Chính Hãng</h1>
    <div class="brand-description">
        <p>Đồng hồ Hublot luôn chiếm trọn tâm điểm với triết lý "The Art of Fusion" qua các bộ sưu tập lừng danh như Big Bang mạnh mẽ, Classic Fusion thanh lịch hay Spirit of Big Bang đầy phá cách. Tại Việt Nam, Hublot là sự lựa chọn số một của giới mộ điệu và những người dẫn đầu xu hướng.</p>
    </div>
            ...
            <div class="hublot-track" style="display: flex !important; width: 100%; margin: 0; padding: 0;">
                <?php if ($result && $result->num_rows > 0): ?>
                    ...
                    <div class="product-item">
                        <a href="chi_tiet_sp/chi_tiet_hublot.php?id=<?php echo $row['id']; ?>" style="display:block; text-decoration:none; color:inherit;">
