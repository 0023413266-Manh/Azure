...
.product-item-custom {
    flex: 0 0 calc(25% - 15px); /* Cố định 4 sản phẩm trên 1 hàng */
...
<section class="banner">
    <div class="banner-slider">
        <div class="banner-item active">
            <img src="image/nenhublot.jpg" alt="Hublot Premium" onerror="this.src='image/nenrolex.jpg'" style="width:100%; height:auto;">
        </div>
    </div>
</section>
...
<div class="hublot-container">
    ...
    <h1 class="main-title" style="margin-top: 10px;">Đồng Hồ Hublot Chính Hãng</h1>
