...
// CASIO = ID 4
$sql = "SELECT * FROM san_pham WHERE id_thuong_hieu = 4 $price_sql $order_sql";
$result = $conn->query($sql);
?>

<!-- CSS TỐI ƯU CHUẨN GRID - KHÔNG LO VỠ GIAO DIỆN -->
<style>
.casio-container {
    max-width: 1200px;
    margin: 0 auto;
...
.product-item-custom {
    flex: 0 0 calc(25% - 15px); /* Đúng 4 sản phẩm / 1 hàng */
...
<section class="banner">
    <div class="banner-slider">
        <div class="banner-item active">
            <img src="image/nencasio.jpg" alt="Casio Premium" style="width:100%; height:auto;">
        </div>
    </div>
</section>

<div class="casio-container">
    <nav class="breadcrumb"><a href="index.php">Home</a> >> <span class="current-page">Đồng Hồ Casio Chính Hãng Giá Tốt Nhất</span></nav>
    <h1 class="main-title" style="margin-top: 10px;">Đồng Hồ Casio Chính Hãng</h1>
    <div class="brand-description">
        <p>Đồng hồ Casio luôn khẳng định vị thế vững chắc với các bộ sưu tập huyền thoại như G-Shock mạnh mẽ, Baby-G năng động, Edifice lịch lãm hay dòng Casio Vintage mang đậm hơi thở hoài cổ.</p>
    </div>
    ...
    <!-- DANH SÁCH SẢN PHẨM (ĐÃ KHẮC PHỤC HOÀN TOÀN LỖI VỠ GRID DÙNG MULTI-LANGUAGE) -->
    <div class="product-grid-custom">
        <?php if ($result && $result->num_rows > 0): ?>
            <?php while($row = $result->fetch_assoc()): ?>
            <div class="product-item-custom">
                <a href="chi_tiet_sp/chi_tiet_casio.php?id=<?php echo $row['id']; ?>" style="display:block; text-decoration:none; color:inherit;">
