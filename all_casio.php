...
<head>
    <meta charset="UTF-8">
    <title>Đồng hồ Casio Chính Hãng - Timeless</title>
        ...
        <ul>
            ...
            <li class="dropdown"><a href="#" style="color: #b58b5a; font-weight: bold;">THƯƠNG HIỆU <i class="fa fa-caret-down"></i></a>
                <ul class="dropdown-content">
                    ...
                    <li><a href="all_casio.php" style="color:#b58b5a;font-weight:bold;">CASIO</a></li>
...
<section class="banner">
    <div class="banner-slider">
        <div class="banner-item active">
            <img src="image/nencasio.jpg" alt="Casio Premium">
        </div>
    </div>
</section>
...
<div class="product-page-header">
    ...
    <h1 class="main-title">Đồng Hồ Casio Chính Hãng</h1>
