...
// 2. DANH SÁCH MÃ SẢN PHẨM NỮ (Giữ nguyên 100% nội dung gốc)
$list_ref = [
    "278288RBR", "126598TBR", "52508",
    // hublot
    "440.NX.1101.RW.1704", "440.NX.1101.RW.1704", "361.PE.2010.RW.1104", "465.SE.2010.RW.1604",
    //casio
    "SHB-200D-7ADR", "S500CG-1ADR", "S2100BC-1ADR", "GM-S2110-7A6DR",
    //seiko
    "SARY111", "SSA875J1 ",
    // omega
    "424.10.37.20.01.001", "424.25.24.60.55.001"
];
...
<div class="product-page-header">
    <nav class="breadcrumb"><a href="index.php">Home</a> >> <span class="current-page">Đồng Hồ Nữ Chính Hãng</span></nav>
    <h1 class="main-title">Đồng Hồ Nữ Chính Hãng Giá Tốt Nhất</h1>
    <div class="brand-description">
        <p>Mua đồng hồ Nữ chính hãng tại Timeless với mức giá tốt nhất ngay hôm nay & tận hưởng đặc quyền dịch vụ đẳng cấp.</p>
    </div>
